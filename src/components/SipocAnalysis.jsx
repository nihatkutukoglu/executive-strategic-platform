...
import { Layers, Box, Cpu, FileOutput, Users, X, AlertTriangle } from 'lucide-react';
...
const sipocItems = [
  ...
  { id: 'p', letter: 'P', title: 'Process', icon: Cpu, color: 'text-yellow-400', bg: 'bg-yellow-500/10', details: [
    'Hasat → Fabrika Kabul → Yıkama & Seçme', 
    'Sıkma, İşleme ve Pastörizasyon', 
    'Kalite Kontrol ve SAP İzlenebilirlik', 
    'Paketleme → Soğuk Hava Depolama', 
    { 
